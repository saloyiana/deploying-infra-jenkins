...
resource "aws_route53_zone" "sarah_dobc" {
  name = "sarah.dobc"
  tags = module.tags_network.tags
...
resource "aws_route53_record" "webserver" {
  zone_id = aws_route53_zone.sarah_dobc.id
  name    = "webserver"
  type    = "A"
  ttl     = 300
...
inline =[
 "sudo echo MY IP: ${aws_instance.api[count.index].public_ip} > /home/ubuntu/home_enginx/index.html ",
]
}
}
